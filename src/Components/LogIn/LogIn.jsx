          ...
          <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            <form>
              ...
              <div className="text-center text-lg-start mt-4 pt-2">
                <button onClick={()=>HandleClick()} type="button" data-mdb-button-init data-mdb-ripple-init className="btn btn-primary btn-lg" style={{ paddingLeft: '2.5rem', paddingRight: '2.5rem' }}>
                  Login
                </button>
                <p className="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a onClick={()=>HandleClick()} className="link-danger">Register</a></p>
              </div>
            </form>
          </div>
        </div>
